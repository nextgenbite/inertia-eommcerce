    ...
    <app-layout>
        ...
        <div class="card">
            ...
            <Edit
                ...
                :title="props.title"
            />
            <Button v-show="can(['permission.create'])" label="Create" @click="data.createOpen = true" icon="pi pi-plus" />
            <DataTable lazy :value="permissions.data" paginator  :rows="permissions.per_page" :totalRecords="permissions.total" :first="(permissions.current_page - 1) * permissions.per_page"   @page="onPageChange"  tableStyle="min-width: 50rem">
                ...
                <Column :exportable="false" style="min-width: 12rem">
                    <template #body="slotProps">
                        <Button v-show="can(['permission.edit'])" icon="pi pi-pencil" outlined rounded class="mr-2"  @click="
                                                    (data.editOpen = true),

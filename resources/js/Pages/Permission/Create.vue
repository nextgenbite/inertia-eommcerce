        ...
        <form @submit.prevent="create">
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <InputText id="group_name" v-model="form.group_name" class="flex-auto" autocomplete="off" placeholder="Group Name" />    
                    <small v-if="form.errors.group_name" class="text-red-500">{{ form.errors.group_name }}</small>  
                </div>

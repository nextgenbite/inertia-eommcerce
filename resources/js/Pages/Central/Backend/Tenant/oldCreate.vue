    ...
    <div id="home" class="overflow-hidden">
       <div class="py-6 px-6 mx-0 md:mx-12 lg:mx-20 lg:px-20 flex items-center justify-between relative lg:static">
                <a class="flex items-center" href="#">
                    ...
                    <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">NextGenBite</span>
                </a>
                <Button
                    class="lg:!hidden"
                    text
                ...
                <div class="items-center bg-surface-0 dark:bg-surface-900 grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-20 rounded-border">
                    <ul class="list-none p-0 m-0 flex lg:items-center select-none flex-col lg:flex-row cursor-pointer gap-8">
                        ...
                        <li>
                            <Link href="/tenant" class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                                <span>Tenant</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="/tenant-register" class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
      ...
      <Card>
        <template #content>
          <form @submit.prevent="createTenant" class="container card">

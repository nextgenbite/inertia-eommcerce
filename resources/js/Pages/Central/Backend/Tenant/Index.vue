...
defineProps({ data: Object, central_domain: String });
            ...
            <template #body="slotProps">
              <ButtonGroup>
                <Button
                  as="a"
                  label="Visit"
                  :href="`http://${slotProps.data.domain}${
                    central_domain == 'localhost' ? ':8000' : ''
                  }`"
                  target="_blank"
                  rel="noopener"
                />
                <Button asChild v-slot="btnslotProps" severity="danger">
                  <Link
                    :href="`/tenant/delete/${slotProps.data.id}`"
                    method="delete"
                    as="button"
                    :class="btnslotProps.class"
                    >Delete</Link
                  >
                </Button>
              </ButtonGroup>

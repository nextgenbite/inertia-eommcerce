            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        <img v-if="$page.props.settings?.logo" class=" h-20 mx-auto" :src="`/${$page.props.settings?.logo}`" alt="logo">
                        <svg v-else viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-8 w-16 shrink-0 mx-auto">
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4 capitalize">Welcome to {{$page.props.settings?.app_name}}!</div>

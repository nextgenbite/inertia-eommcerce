...
defineProps({ central_domain: String });
const value = ref("0");
const form = useForm({
  company_name: "",
  name: "",
      ...
      <Card>
        ...
        <Tab value="2">Header III</Tab>
            ...
            <TabPanels>
              <TabPanel value="0">
                <div
                  class="flex min-h-screen w-full flex-wrap items-stretch bg-white dark:bg-gray-800 max-md:pb-20 max-md:pt-32"
                >
                  <div
                    class="grow md:flex md:w-1/2 md:flex-col md:items-center md:justify-center md:py-20"
                  >
                    <div class="w-full px-4 text-center text-xs lg:w-1/2">
                      <h1
                        class="mb-8 text-2xl font-bold text-gray-800 dark:text-white"
                      >
                        Welcome Back
                      </h1>
                      ...
                      >
                        ...
                        <div class="relative">
                          ...
                          <input
                            id="email"
                            class="block peer w-full px-4 py-3 border border-gray-300 bg-gray-100 text-gray-800 placeholder-gray-500 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:placeholder-gray-400 transition-colors focus:border-primary-500 focus:outline-0 focus:ring focus:ring-primary-200 dark:focus:ring-primary-500"
                            name=""
                            value=""
                            type="email"
                          ...
                          <div class="grow">
                            <div class="relative">
                              ...
                              >
                                <input
                                  id="remember"
                                  class="peer rounded border-gray-300 dark:border-gray-600 focus:ring focus:ring-primary-200 dark:focus:ring-primary-500"
                                  name="remember"
                                  type="checkbox"
                                />
                        ...
                        <button
                          class="lqd-btn group inline-flex items-center justify-center gap-1.5 font-medium rounded-full transition-all hover:-translate-y-0.5 hover:shadow-xl lqd-btn-primary bg-primary-600 text-white hover:bg-primary-500 focus-visible:bg-primary-700 focus-visible:shadow-primary-300/10 px-5 py-3"
                          id="LoginFormButton"
                          type="submit"
                        >
                          Sign in
                      ...
                      <div class="mt-20 text-gray-600 dark:text-gray-400">
                        ...
                        <Button @click="value = '1'" text>Sign up</Button>
                      </div>
                    </div>
                  </div>

                  <div
                    class="hidden flex-col justify-center bg-primary rounded-lg rounded-bl-[20rem] md:flex md:w-1/2 text-white"
                  >
<div class="text-center">
    Don't Have and Acoount Yet?
</div>
<div class="text-center">
   Let's get you all set up so you can start creating your frist<br>
   onboading experiance
</div>
<Button label="Sign Up" severity="secondary" raised  class="w-60 mx-auto"  @click="value = '1'"/>
                  </div>
                </div>
              </TabPanel>
              <TabPanel value="1">
                <div
                  class="flex min-h-screen w-full flex-wrap items-stretch  dark:bg-gray-800 max-md:pb-20 max-md:pt-32"
                >


                  <div
                    class="hidden flex-col justify-center bg-primary text-white rounded-lg rounded-br-[20rem]
...
<Button label="Sign In" severity="secondary" raised  class="w-60 mx-auto"  @click="value = '0'"/>
                  </div>
   ...
   onboading experiance
          ...
          <form @submit.prevent="createTenant" class="card">

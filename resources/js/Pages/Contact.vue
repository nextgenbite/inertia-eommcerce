...
<template>
  <DefaultLayout>
  <section class="bg-primary-50 dark:bg-slate-800" id="contact">
            ...
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    ...
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-primary text-gray-100">
                                <svg c xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"

...
<template>
        <nav
      class="py-2 lg:py-0 bg-white/20 backdrop-blur-sm border-b-default border-solid border-gray-200 z-10 w-full  lg:fixed"
      id="topnav"
    >
        ...
        <div class="w-full flex flex-col lg:flex-row">
          <div class="flex justify-between lg:hidden px-4">
            <Link href="/" class="flex items-center">
                   <img
              :src="`/${$page.props.settings.favicon ? $page.props.settings.favicon : 'no-image.png'}` "
              alt="logo"
              class="w-full h-12  object-contain"
            />
            </Link>
            <button
                v-styleclass="{ selector: '#navbar', enterFromClass: 'hidden', enterActiveClass: 'animate-slidedown', leaveToClass: 'hidden', leaveActiveClass: 'animate-fadeout', hideOnOutsideClick: true }"
          ...
          >
                 ...
                 <Link href="/" class="hidden lg:flex items-center lg:flex-1">
                   <img
              :src="`/${$page.props.settings.logo ? $page.props.settings.logo : 'no-image.png'}` "
              alt="logo"
              class="w-full h-12  object-contain"
            />
            </Link>
            <ul
              class="flex lg:items-center max-lg:gap-4 max-lg:mb-4 flex-col mt-4  md:mt-0 lg:flex-row"
            >
              <li>
                <Link
                  href="/"
                  class="text-gray-500 text-sm font-medium hover:text-primary-700 transition-all duration-500 mb-2 block lg:mr-6 lg:text-base md:mb-0 md:mr-3 "
                  >Home
                  </Link>
              </li>
              <li>
              ...
              <li class="relative">
                <button
                  ...
                  class="dropdown-toggle flex items-center justify-between text-gray-500 text-sm lg:text-base font-medium hover:text-primary-700 transition-all duration-500 lg:mr-6 lg:mb-0 mr-auto lg:text-left lg:m-0 "
                >
                  Products
                  <svg
                  ...
                  <div class="flex flex-col sm:flex-row lg:justify-between">
                        ...
                        >
                          ...
                          <div class="ml-4 w-4/5">
                            ...
                            >
                              Analytics
                              <span
                                class="bg-primary-50 text-primary-500 text-xs font-medium mr-2 px-2.5 py-1 rounded-full h-5 ml-4"
                                >New</span
                              >
                            </h5>
                            <p class="text-xs font-medium text-gray-400">
                    ...
                    >
                      ...
                      <li class="">
                        ...
                        >
                          <div
                            class="bg-primary-50 rounded-lg w-12 h-12 flex items-center justify-center"
                          >
                            <svg
                              width="38"
                              height="38"
              ...
              <li class="relative">
                <div class="dropdown relative inline-flex">
                  <button
                    ...
                    class="dropdown-toggle flex items-center justify-between text-gray-500 text-sm max-lg:h-max text-center lg:text-base font-medium hover:text-primary-700 transition-all duration-500 mb-2 lg:mr-6 lg:mb-0 mr-auto lg:text-left lg:m-0 "
                  >
                    Features
                    <svg
                      class="w-3 h-2 ml-1.5 dropdown-active-rotate-180"
            ...
            >
              <Link href="/login"
                class="bg-primary-50 text-primary-600 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-3 px-6 text-sm hover:bg-primary-100"
              >
                Login
              </Link>
              <Link href="/register"
                class="bg-primary-600 text-white rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-3 px-6 text-sm lg:ml-5 hover:bg-primary-700"
              >
                Sign up
              </Link>
            </div>

// Convert primaryColors and surfaces to object maps for O(1) lookup
...
].map(color => [color.name, color.palette]));
...
].map(surface => [surface.name, surface.palette]));

export { primaryColors, surfaces };

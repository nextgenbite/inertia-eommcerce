...
const model = ref([
  ...
  },
  {
    label: "Contact",
    items: [
      { label: "Customer", icon: "pi pi-fw pi-users", to: "/admin/customers" },
    ],
  },
  {
    items: [
      { label: "Suppiler", icon: "pi pi-fw pi-truck", to: "/admin/suppliers" },
    ],
  },
  {

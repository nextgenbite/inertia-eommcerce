...
class RepositoryServiceProvider extends ServiceProvider
{
    public function register()
    {
        // Tenancy
        $this->app->bind(
            'App\Repositories\Interfaces\Tenancy\DomainInterface',
            'App\Repositories\Tenancy\DomainRepository'
        );
        $this->app->bind(
            'App\Repositories\Interfaces\Tenancy\PlanInterface',
            'App\Repositories\Tenancy\PlanRepository'
        );
        $this->app->bind(
            'App\Repositories\Interfaces\Tenancy\TenantInterface',
            'App\Repositories\Tenancy\TenantRepository'
        );

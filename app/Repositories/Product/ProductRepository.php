...
class ProductRepository implements ProductInterface
{
    ...
    public function baseData(): array
    {
        ...
        $form = [
            ...
            ['key' => 'brand_id', 'label' => 'Brand', 'path' => 'brand_id', 'type' => 'select', 'class' => ' lg:col-span-6', 'optionLabel' => 'title', 'optionValue' => 'id', 'options' => Brand::select('id', 'title')->get()],
            ['key' => 'weight', 'label' => 'Weight', 'path' => 'weight', 'type' => 'number', 'value' => '6', 'class' => ' lg:col-span-6'],
            ['key' => 'unit_id', 'label' => 'Weight Unit', 'path' => 'unit_id', 'type' => 'select', 'class' => ' lg:col-span-6', 'optionLabel' => 'title', 'optionValue' => 'id', 'options' => Unit::select('id', 'title')->get()],

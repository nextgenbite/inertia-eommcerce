...
use App\Models\TenantUser as User;
use Inertia\Inertia;
...
Route::middleware('tenant.guard','auth.tenant', 'verified')->group(function () {
...
Route::prefix('admin')->middleware(['tenant.guard','auth.tenant', 'verified'])->group(function () {
